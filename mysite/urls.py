...
# Custom logout view allowing GET (for testing only)
class LogoutGetAllowedView(LogoutView):
    http_method_names = ['get', 'post']  # allow GET and POST

    def get(self, request, *args, **kwargs):
        """
        Treat GET like a POST for compatibility.
        """
        return self.post(request, *args, **kwargs)

    def post(self, request, *args, **kwargs):
        """
        Actually log out, then redirect.
        """
        super().post(request, *args, **kwargs)  # logs the user out
